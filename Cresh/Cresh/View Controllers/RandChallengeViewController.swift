//
//  RandChallengeViewController.swift
//  Cresh
//
...
class RandChallengeViewController: UIViewController, ConfigurationViewControllerDelegate, VideoCaptureDelegate, PoseNetDelegate {
