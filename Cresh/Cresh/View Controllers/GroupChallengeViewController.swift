//
//  GroupChallengeViewController.swift
//  Cresh
//
...
class GroupChallengeViewController: UIViewController, ConfigurationViewControllerDelegate, VideoCaptureDelegate, PoseNetDelegate {
    ...
    @IBOutlet weak var randPreviewImageView: PoseImageView!
